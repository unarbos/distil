...
Items: ``distil.pod.axes.v31.math_robustness.generate_items``.
Grader: shared math extractor + scorer.
"""
...
from distil.pod.axes.v31 import math_robustness as _v31

MAX_TOKENS = 768
AXIS_NAME = "v31_math_robustness"
...
def run(engine, *, block_seed: int, n_items: int) -> dict:
    ...
    return run_axis(
        ...
        extra_item_keys=("perturbation", "template"),
    )
